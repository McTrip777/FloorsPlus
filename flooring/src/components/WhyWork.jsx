...
import ThreeGens from '../img/three-generations.jpg'
...
function WhyWork() {
    return (
        <div>
            ...
            <p>We know you have several options when choosing a hardwood flooring contractor to work with, but here’s a few reasons that sets us apart from our competition: </p>
            ...
            <div className="box boxThree">
                <div>
                    ...
                    <p>Mattson Floor is a Bona Certified Craftsman, trained and certified by Bona for their complete hardwood floor finishing system.  The Five-Star advantage* includes:</p>
                    <ol>
                    ...
                    <p>* as taken from Bona’s promotional materials</p>
                </div>
                <div>
